...
export default class Timing extends Component {
    ...
    return (
      <>
        <View style={[styles.navbar.navView]}>
          ...
          <Text
            style={[styles.navbar.navTxt, {position: 'absolute', left: 170}]}>
            Timing
          </Text>
        </View>
      </>
  ...
  getTimmingApi = () => {
    ...
    fetch(
      "https://myrankelearningapp-96162-ruby.b96162.dev.eastus.az.svc.builder.cafe//bx_block_scheduling/live_classes/class_timings",
      requestOptions,
    )
      .then(response => response.json())
      .then(result => {
        console.log('getTimmingApi-->', result);
            ...
            <FlatList
              ...
              renderItem={({item}) => (
                <View
                  ...
                  />
                  <Text
                    style={{fontSize: 16, fontWeight: '600', marginLeft: 20,width:'85%'}}>
                    {item.content}
                  </Text>
                </View>
              )}
