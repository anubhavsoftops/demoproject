        ...
        <View
          ...
          <View
            ...
            <Image
              ...
              source={require('./src/linkPurple.png')}
            />
          ...
          <Text style={{marginTop:50,marginBottom:40}}>Add website</Text>
          <Text style={{textAlign:'center',fontSize:25,fontWeight:'bold',marginBottom:10}}>www.</Text>
          <Text style={{textAlign:'center',fontSize:25,fontWeight:'bold',color:'#8634eb'}}>XYSTUDIO.CO</Text>
          </View>
          <View>
